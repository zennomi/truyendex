...
const buttonClassName =
  "cursor-pointer rounded border border-slate-600 p-1.5 text-slate-500 hover:bg-slate-100 hover:text-slate-900 dark:text-slate-400 dark:hover:bg-slate-600 dark:hover:text-white";

const activedButtonClassName =
  "cursor-pointer rounded border border-slate-600 p-1.5 bg-slate-600 text-white";
      ...
      <div className="flex flex-wrap items-center">
        <div className="mb-1 flex flex-wrap items-center gap-1">
          ...
          <button
            ...
            title="Xóa định dạng"
          >
            <Iconify className="h-5 w-5" icon="lucide:x" />
          </button>
          <button
          ...
          <button
            ...
            title="Hoàn tác"
          >
            <Iconify className="size-5" icon="lucide:undo" />
          </button>
          <button
            ...
            title="Hủy hoàn tác"
          >
            <Iconify className="size-5" icon="lucide:redo" />
          </button>
...
const DiscussionCommentEditor = ({
  ...
  return (
    <div className="">
      ...
      <div className="w-full rounded border border-slate-200 bg-slate-50 px-2 py-2 dark:border-slate-600 dark:bg-slate-900">
        <EditorContent editor={editor} />
      </div>
      <div className="flex justify-end py-3">
        <Button size="sm" onClick={submitCommentClick}>
          Đăng bình luận
        </Button>
      </div>
    </div>
...
export default DiscussionCommentEditor;
