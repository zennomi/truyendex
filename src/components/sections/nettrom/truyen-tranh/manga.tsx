    ...
    <>
      ...
      <article id="item-detail">
        ...
        <time className="small">
          [Cập nhật lúc:{" "}
          {Utils.Date.formatNowDistance(new Date(manga.attributes.updatedAt))}{" "}
          trước]
        </time>
          ...
          <div className="row">
            ...
            <div className="col-xs-8 col-info">
              ...
              <div className="mrt5 mrb10" itemType="http://schema.org/Book">
                <a href={Constants.Routes.nettrom.manga(manga.id)}>
                  <span itemProp="name">{title}</span>
                </a>
                <span
              ...
              <div className="follow">
                ...
                {user ? (
                  ...
                  >
                    <Iconify icon="fa:heart" className="mr-2 inline" />
        ...
        <div className="detail-content">
          ...
          <div className="">
            ...
            được cập nhật nhanh và đầy đủ nhất tại {Constants.APP_NAME}. Bạn đọc
            đừng quên để lại bình luận và chia sẻ, ủng hộ {Constants.APP_NAME}{" "}
            ra các chương mới nhất của truyện <a href={url}>{title}</a>.
          </div>
