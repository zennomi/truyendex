...
export default function Collapse({ title, content, defaultValue = false }: Props) {
    const [value, toggle] = useToggle(defaultValue)

    return (
        <div className={`transition-all relative shadow dark:shadow-gray-800 rounded-md overflow-hidden`}>
