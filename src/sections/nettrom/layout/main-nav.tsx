    ...
    <div className="Module Module-144">
      <div className="ModuleContent">
        <ul className="nav navbar-nav main-menu">
          ...
          <li>
            <Link target="_self" href={routes.nettrom.following}>
              Theo dõi
            </Link>
          </li>
          <li>
          ...
          <li>
            <Link target="_self" href={routes.nettrom.history}>
              Lịch sử
            </Link>
          </li>
                    ...
                    <div className="col-sm-3" key={col[0].id}>
                      <ul className="nav">
                        {col.map((tag) => (
                          <li key={tag.id}>
                            <Link
                              title={transLocalizedStr(
                                tag.attributes.description,
                              )}
                              data-title={transLocalizedStr(
                                tag.attributes.description,
                              )}
                              href={`${routes.nettrom.search}?includedTags=${tag.id}#results`}
                            >
          ...
          <li>
            <Link target="_self" href={routes.nettrom.search}>
              Tìm truyện
            </Link>
          </li>
          <li>
          ...
          <li>
            <Link
              target="_self"
              href={`${routes.nettrom.search}?publicationDemographic=seinen&publicationDemographic=shounen#results`}
            >
              Con trai
            </Link>
          </li>
