            ...
            return (
              <div className="group" key={extended.id}>
                <div className="relative overflow-hidden shadow dark:shadow-gray-800 group-hover:shadow-lg group-hover:dark:shadow-gray-800 rounded-md duration-500">
                  <Image src={getCoverArt(extended)} alt={title} />

                  <div className="absolute -bottom-20 group-hover:bottom-3 start-3 end-3 duration-500">
                    <Link
                      href={routes.nettrom.manga(extended.id)}
                  ...
                  {extended.attributes.publicationDemographic && (
                    <ul className="list-none absolute top-[10px] start-4">
                      <li>
                        <span className="bg-orange-600 text-white text-[10px] font-bold px-2.5 py-0.5 rounded h-5">
                ...
                <div className="mt-4">
                  <Link
                    href={routes.nettrom.manga(extended.id)}
                    className="hover:text-indigo-600 md:text-lg text-sm font-semibold"
                  >
                    {title}
                  </Link>
