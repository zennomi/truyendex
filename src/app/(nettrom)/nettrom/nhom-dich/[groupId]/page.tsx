...
export default async function NhomDich({ params }: { params: { groupId: string } }) {
    ...
    const members = group.relationships.filter(r => r.type === "member") as unknown as User[]
        ...
        <div className="row">
            <div id="ctl00_divCenter" className="center-side col-md-8">
                <article id="item-detail">
                    ...
                    {group.attributes.focusedLanguages && <time className="small">Ngôn ngữ: {group.attributes.focusedLanguages.map(l => l.toUpperCase()).join("; ")}</time>}
                    <div className="detail-info md:ps-3">
                            ...
                            <ul className="list-info">
                                {
                                    ...
                                    <li className="author row">
                                        ...
                                        <p className="col-xs-8">{leaders.map(l => l.attributes.username).join("; ")}</p>
                                    </li>
                                }
                                {
                                    members.length > 0 &&
                                    <li className="author row">
                                        ...
                                        <p className="col-xs-8">{members.map(l => l.attributes.username).join("; ")}</p>
                                    </li>
                                }
                                {
                        ...
                        <div className="follow">
                            <a className="btn btn-danger" href={`https://mangadex.org/group/${group.id}`} target="_blank">
                    ...
                    <div className="detail-content">
                        ...
                        <p className="">
                            {
                                group.attributes.description && <ReactMarkdown>
