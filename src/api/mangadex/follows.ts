 ...
 */
export const getUserFollowsGroup = function (
  token: AuthenticationToken,
  options?: GetUserFollowsGroupRequestOptions,
) {
  ...
  try {
    ...
    return util.createHttpsRequestPromise<GetUserFollowsGroupResponse>(
      "GET",
      path,
      httpsRequestOptions,
    );
 ...
 */
export const getUserFollowsGroupId = function (
  id: string,
  token: AuthenticationToken,
) {
  if (id === undefined) {
    return Promise.reject(
      "ERROR - getUserFollowsGroupId: Parameter `id` cannot be undefined",
    );
  } else if (id === "") {
    return Promise.reject(
      "ERROR - getUserFollowsGroupId: Parameter `id` cannot be blank",
    );
  }
  ...
  try {
    const httpsRequestOptions = util.addTokenAuthorization(token);
    return util.createHttpsRequestPromise<GetUserFollowsGroupIdResponse>(
      "GET",
      path,
      httpsRequestOptions,
    );
 ...
 */
export const getUserFollowsUser = function (
  token: AuthenticationToken,
  options?: GetUserFollowsUserRequestOptions,
) {
  const qs = util.buildQueryStringFromOptions(options);
  ...
  try {
    const httpsRequestOptions = util.addTokenAuthorization(token);
    return util.createHttpsRequestPromise<GetUserFollowsUserResponse>(
      "GET",
      path,
      httpsRequestOptions,
    );
