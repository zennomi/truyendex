 ...
 * Can also resolve to an {@link ErrorResponse} object.
 */
export const postAuthor = function (
  options: PostAuthorRequestOptions,
  token: AuthenticationToken,
) {
  if (options === undefined) {
    return Promise.reject(
      "ERROR - postAuthor: Parameter `options` cannot be undefined",
    );
  } else if (!("name" in options)) {
    return Promise.reject(
      "ERROR - postAuthor: Parameter `options` missing required property `name`",
    );
  }
  ...
  try {
    ...
    return util.createHttpsRequestPromise<PostAuthorResponse>(
      "POST",
      path,
      httpsRequestOptions,
    );
 ...
 * Can also resolve to an {@link ErrorResponse} object.
 */
export const getAuthorId = function (
  id: string,
  options?: GetAuthorIdRequestOptions,
) {
  if (id === undefined) {
    return Promise.reject(
      "ERROR - getAuthorId: Parameter `id` cannot be undefined",
    );
  } else if (id === "") {
    return Promise.reject(
      "ERROR - getAuthorId: Parameter `id` cannot be blank",
    );
  }
 ...
 * Can also resolve to an {@link ErrorResponse} object.
 */
export const putAuthorId = function (
  id: string,
  options: PutAuthorIdRequestOptions,
  token: AuthenticationToken,
) {
  if (id === undefined) {
    return Promise.reject(
      "ERROR - putAuthorId: Parameter `id` cannot be undefined",
    );
  } else if (id === "") {
    return Promise.reject(
      "ERROR - putAuthorId: Parameter `id` cannot be blank",
    );
  } else if (options === undefined) {
    return Promise.reject(
      "ERROR - putAuthorId: Parameter `options` cannot be undefined",
    );
  } else if (!("version" in options)) {
    return Promise.reject(
      "ERROR - putAuthorId: Parameter `options` missing required property `version`",
    );
  }
  ...
  try {
    const httpsRequestOptions = util.addTokenAuthorization(token, req);
    return util.createHttpsRequestPromise<PutAuthorIdResponse>(
      "PUT",
      path,
      httpsRequestOptions,
    );
 ...
 * Can also resolve to an {@link ErrorResponse} object.
 */
export const deleteAuthorId = function (
  id: string,
  token: AuthenticationToken,
) {
  if (id === undefined) {
    return Promise.reject(
      "ERROR - deleteAuthorId: Parameter `id` cannot be undefined",
    );
  } else if (id === "") {
    return Promise.reject(
      "ERROR - deleteAuthorId: Parameter `id` cannot be blank",
    );
  }
  ...
  try {
    ...
    return util.createHttpsRequestPromise<DeleteAuthorIdResponse>(
      "DELETE",
      path,
      httpsRequestOptions,
    );
