 ...
 */
export const getCoverId = function (
  id: string,
  options?: GetCoverIdRequestOptions,
) {
  if (id === undefined) {
    return Promise.reject(
      "ERROR - getCoverId: Parameter `id` cannot be undefined",
    );
  } else if (id === "") {
 ...
 * Can also reject to an {@link ErrorResponse} object.
 */
export const editCover = function (
  id: string,
  options: EditCoverRequestOptions,
  token: AuthenticationToken,
) {
  if (id === undefined) {
    return Promise.reject(
      "ERROR - editCover: Parameter `id` cannot be undefined",
    );
  } else if (id === "") {
  ...
  try {
    ...
    return util.createHttpsRequestPromise<EditCoverResponse>(
      "PUT",
      path,
      httpsRequestOptions,
    );
...
export const deleteCover = function (id: string, token: AuthenticationToken) {
  if (id === undefined) {
    return Promise.reject(
      "ERROR - deleteCover: Parameter `id` cannot be undefined",
    );
  } else if (id === "") {
    return Promise.reject(
      "ERROR - deleteCover: Parameter `id` cannot be blank",
    );
  }
  ...
  try {
    ...
    return util.createHttpsRequestPromise<DeleteCoverResponse>(
      "DELETE",
      path,
      httpsRequestOptions,
    );
