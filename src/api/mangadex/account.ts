...
export const getAccountAvailable = function (username: string) {
  console.warn(
    "The function `getAccountAvailable` is using a deprecated endpoint. Please consider removing it as it may not work in the future.",
  );

  if (username === undefined) {
    return Promise.reject(
      "ERROR - getAccountAvailable: Parameter `username` cannot be undefined",
    );
  } else if (username === "") {
    return Promise.reject(
      "ERROR - getAccountAvailable: Parameter `username` cannot be empty",
    );
  }
  ...
  return util.createHttpsRequestPromise<GetAccountAvailableResponse>(
    "GET",
    path,
  );
};
 ...
 * Can also resolve to an {@link ErrorResponse} object.
 */
export const postAccountCreate = function (
  options: PostAccountCreateRequestOptions,
) {
  console.warn(
    "The function `postAccountCreate` is using a deprecated endpoint. Please consider removing it as it may not work in the future.",
  );

  if (!options) {
    return Promise.reject(
      "ERROR - postAccountCreate: Parameter `options` cannot be undefined",
    );
  } else if (!options.username || options.username === "") {
    return Promise.reject(
      "ERROR - postAccountCreate: Request missing required value `username`",
    );
  } else if (!options.password || options.password === "") {
    return Promise.reject(
      "ERROR - postAccountCreate: Request missing required value `password`",
    );
  } else if (!options.email || options.email === "") {
    return Promise.reject(
      "ERROR - postAccountCreate: Request missing required value `email`",
    );
  }
  ...
  return util.createHttpsRequestPromise<PostAccountCreateResponse>(
    "POST",
    path,
    req,
  );
...
export const getAccountActivateCode = function (code: string) {
  console.warn(
    "The function `getAccountActivateCode` is using a deprecated endpoint. Please consider removing it as it may not work in the future.",
  );

  if (code === undefined) {
    return Promise.reject(
      "ERROR - getAccountActivateCode: Parameter `code` cannot be undefined",
    );
  } else if (!code.match(/^[0-9a-fA-F-]+$/)) {
    return Promise.reject(
      "ERROR - getAccountActivateCode: Invalid format for parameter `code`",
    );
  }

  const path = `/account/activate/${code}`;

  return util.createHttpsRequestPromise<GetAccountActivateCodeResponse>(
    "POST",
    path,
  );
};
 ...
 * Can also resolve to an {@link ErrorResponse} object.
 */
export const postAccountActivateResend = function (
  options: PostAccountActivateResendRequestOptions,
) {
  console.warn(
    "The function `postAccountActivateResend` is using a deprecated endpoint. Please consider removing it as it may not work in the future.",
  );

  if (options === undefined) {
    return Promise.reject(
      "ERROR - postAccountActivateResend: Parameter `options` cannot be undefined",
    );
  } else if (!("email" in options)) {
    return Promise.reject(
      "ERROR - postAccountActivateResend: Parameter `options` missing required property `email`",
    );
  }
  ...
  return util.createHttpsRequestPromise<PostAccountActivateResendResponse>(
    "POST",
    path,
    req,
  );
 ...
 * Can also resolve to an {@link ErrorResponse} object.
 */
export const postAccountRecover = function (
  options: PostAccountRecoverRequestOptions,
) {
  console.warn(
    "The function `postAccountRecover` is using a deprecated endpoint. Please consider removing it as it may not work in the future.",
  );

  if (options === undefined) {
    return Promise.reject(
      "ERROR - postAccountRecover: Parameter `options` cannot be undefined",
    );
  } else if (!("email" in options)) {
    return Promise.reject(
      "ERROR - postAccountRecover: Parameter `options` missing required property `email`",
    );
  }
  ...
  return util.createHttpsRequestPromise<PostAccountRecoverResponse>(
    "POST",
    path,
    req,
  );
 ...
 * Can also resolve to an {@link ErrorResponse} object.
 */
export const postAccountRecoverCode = function (
  code: string,
  options: PostAccountRecoverCodeRequestOptions,
) {
  console.warn(
    "The function `postAccountRecoverCode` is using a deprecated endpoint. Please consider removing it as it may not work in the future.",
  );

  if (code === undefined) {
    return Promise.reject(
      "ERROR - postAccountRecoverCode: Parameter `code` cannot be undefined",
    );
  } else if (code === "") {
    return Promise.reject(
      "ERROR - postAccountRecoverCode: Parameter `code` cannot be blank",
    );
  } else if (options === undefined) {
    return Promise.reject(
      "ERROR - postAccountRecoverCode: Parameter `options` cannot be undefined",
    );
  } else if (!("newPassword" in options)) {
    return Promise.reject(
      "ERROR - postAccountRecoverCode: Parameter `options` missing required property `newPassword`",
    );
  }
  ...
  return util.createHttpsRequestPromise<PostAccountRecoverCodeResponse>(
    "POST",
    path,
    req,
  );
